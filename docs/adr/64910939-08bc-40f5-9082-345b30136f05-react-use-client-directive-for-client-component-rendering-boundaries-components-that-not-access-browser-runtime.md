...
1. MUST_NOT: Components that do not access browser runtime APIs, state hooks such as useState, or effect hooks such as useEffect MUST NOT declare the 'use client' directive.

## Policy Block

- MUST_NOT Components that do not access browser runtime APIs, state hooks such as useState, or effect hooks such as useEffect MUST NOT declare the 'use client' directive.
