...
1. MAY: Scripts MAY include verbose or debug logging modes that provide additional diagnostic output when enabled via command-line flags or environment variables

## Policy Block

- MAY Scripts MAY include verbose or debug logging modes that provide additional diagnostic output when enabled via command-line flags or environment variables
