...
1. MUST: Documentation consumers and content generation endpoints MUST access pages, page trees, and collection metadata exclusively through the centralized source loader abstractions exported from the content source integration layer.

## Policy Block

- MUST Documentation consumers and content generation endpoints MUST access pages, page trees, and collection metadata exclusively through the centralized source loader abstractions exported from the content source integration layer.
