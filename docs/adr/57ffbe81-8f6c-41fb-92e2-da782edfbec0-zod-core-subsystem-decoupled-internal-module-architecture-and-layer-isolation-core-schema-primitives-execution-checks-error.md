...
1. MUST: Core schema primitives, execution checks, error formats, and shared registries MUST reside in decoupled internal submodules that isolate their internal state and export minimal functional contracts.

## Policy Block

- MUST Core schema primitives, execution checks, error formats, and shared registries MUST reside in decoupled internal submodules that isolate their internal state and export minimal functional contracts.
