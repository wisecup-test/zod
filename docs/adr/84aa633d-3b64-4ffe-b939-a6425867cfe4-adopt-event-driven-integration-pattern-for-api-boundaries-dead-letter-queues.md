...
1. SHOULD: Dead letter queues SHOULD be configured for events that cannot be processed after retry attempts

## Policy Block

- SHOULD Dead letter queues SHOULD be configured for events that cannot be processed after retry attempts
