...
1. MUST: Schemas for composite data structures MUST be constructed using z.object with explicit field property schemas.

## Policy Block

- MUST Schemas for composite data structures MUST be constructed using z.object with explicit field property schemas.
