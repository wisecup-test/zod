# Zod Core Library Module: Subsystem Decomposition Across Schemas, Checks, and Registries: Cross Schema Metadata Lookups Global Instances
...
1. MUST: Cross-schema metadata lookups and global schema instances MUST coordinate through the global registry interface rather than maintaining ad-hoc module-local caches.

## Policy Block

- MUST Cross-schema metadata lookups and global schema instances MUST coordinate through the global registry interface rather than maintaining ad-hoc module-local caches.
