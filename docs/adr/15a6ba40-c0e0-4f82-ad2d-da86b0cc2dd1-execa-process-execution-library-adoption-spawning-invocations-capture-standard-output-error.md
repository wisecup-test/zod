...
1. SHOULD: Spawning invocations SHOULD capture standard output and standard error streams asynchronously using the promise-based interfaces provided by execa.

## Policy Block

- SHOULD Spawning invocations SHOULD capture standard output and standard error streams asynchronously using the promise-based interfaces provided by execa.
