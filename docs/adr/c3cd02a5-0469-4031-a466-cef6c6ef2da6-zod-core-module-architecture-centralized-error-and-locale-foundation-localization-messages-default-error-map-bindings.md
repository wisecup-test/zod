...
1. MUST: Localization messages and default error map bindings MUST route through centralized locale definitions provided by the core module to maintain consistent message formatting across all parsing contexts.

## Policy Block

- MUST Localization messages and default error map bindings MUST route through centralized locale definitions provided by the core module to maintain consistent message formatting across all parsing contexts.
