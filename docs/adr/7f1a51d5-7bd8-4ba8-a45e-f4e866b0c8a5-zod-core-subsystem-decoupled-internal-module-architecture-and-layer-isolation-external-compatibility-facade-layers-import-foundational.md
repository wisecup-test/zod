...
1. MUST: External compatibility and facade layers MUST import foundational abstractions unidirectionally from the core subsystem without introducing inverse dependencies from core back to outer layers.

## Policy Block

- MUST External compatibility and facade layers MUST import foundational abstractions unidirectionally from the core subsystem without introducing inverse dependencies from core back to outer layers.
