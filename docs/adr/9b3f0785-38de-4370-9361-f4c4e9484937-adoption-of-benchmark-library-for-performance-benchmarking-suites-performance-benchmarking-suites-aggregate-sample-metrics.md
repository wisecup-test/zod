...
1. SHOULD: Performance benchmarking suites SHOULD aggregate sample metrics, mean execution times, operations per second, and relative margin of error upon suite completion to evaluate comparative performance.

## Policy Block

- SHOULD Performance benchmarking suites SHOULD aggregate sample metrics, mean execution times, operations per second, and relative margin of error upon suite completion to evaluate comparative performance.
