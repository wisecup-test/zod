...
1. MAY: Environment variable names MAY follow a consistent naming convention (e.g., UPPERCASE_WITH_UNDERSCORES)

## Policy Block

- MAY Environment variable names MAY follow a consistent naming convention (e.g., UPPERCASE_WITH_UNDERSCORES)
