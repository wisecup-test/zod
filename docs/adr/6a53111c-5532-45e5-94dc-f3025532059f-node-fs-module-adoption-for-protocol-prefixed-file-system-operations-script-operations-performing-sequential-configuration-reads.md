...
1. SHOULD: Script operations performing sequential configuration reads and static validation SHOULD invoke readFileSync from node:fs to maintain deterministic synchronous execution during repository validation tasks.

## Policy Block

- SHOULD Script operations performing sequential configuration reads and static validation SHOULD invoke readFileSync from node:fs to maintain deterministic synchronous execution during repository validation tasks.
