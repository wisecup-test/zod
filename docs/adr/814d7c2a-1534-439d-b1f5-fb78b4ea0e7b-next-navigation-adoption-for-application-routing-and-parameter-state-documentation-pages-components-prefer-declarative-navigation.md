# next/navigation Adoption for Application Routing and Parameter State: Documentation Pages Components Prefer Declarative Navigation
...
1. SHOULD: Documentation pages and components SHOULD prefer declarative navigation links over imperative navigation calls unless programmatic state transitions are required.

## Policy Block

- SHOULD Documentation pages and components SHOULD prefer declarative navigation links over imperative navigation calls unless programmatic state transitions are required.
