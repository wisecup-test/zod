...
1. MUST: The schema translation pipeline MUST check ctx.refs using ctx.refs.get before compiling any referenced schema path to avoid redundant instance instantiation.

## Policy Block

- MUST The schema translation pipeline MUST check ctx.refs using ctx.refs.get before compiling any referenced schema path to avoid redundant instance instantiation.
