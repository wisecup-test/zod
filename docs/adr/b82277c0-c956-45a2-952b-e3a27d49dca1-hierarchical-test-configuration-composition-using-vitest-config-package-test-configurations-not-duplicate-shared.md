...
1. MUST_NOT: Package test configurations MUST NOT duplicate shared global test runner settings that are already declared within the shared root configuration module.

## Policy Block

- MUST_NOT Package test configurations MUST NOT duplicate shared global test runner settings that are already declared within the shared root configuration module.
