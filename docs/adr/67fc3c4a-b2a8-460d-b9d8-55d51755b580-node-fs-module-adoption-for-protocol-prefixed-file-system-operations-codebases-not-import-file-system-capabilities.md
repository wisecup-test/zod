...
1. MUST_NOT: Codebases MUST NOT import file system capabilities using bare, un-prefixed module specifiers.

## Policy Block

- MUST_NOT Codebases MUST NOT import file system capabilities using bare, un-prefixed module specifiers.
