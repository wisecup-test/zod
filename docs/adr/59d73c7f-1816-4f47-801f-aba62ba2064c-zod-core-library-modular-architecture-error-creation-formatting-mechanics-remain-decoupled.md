...
1. SHOULD: Error creation and formatting mechanics SHOULD remain decoupled from parsing control flows, exposing structured error objects through dedicated error definition interfaces.

## Policy Block

- SHOULD Error creation and formatting mechanics SHOULD remain decoupled from parsing control flows, exposing structured error objects through dedicated error definition interfaces.
