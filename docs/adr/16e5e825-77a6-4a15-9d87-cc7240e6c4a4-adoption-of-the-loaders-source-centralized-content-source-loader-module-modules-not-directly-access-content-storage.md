...
1. MUST_NOT: Modules MUST_NOT directly access content storage mechanisms, read filesystem paths, or configure independent content source loaders outside of the centralized source loader interface.

## Policy Block

- MUST_NOT Modules MUST_NOT directly access content storage mechanisms, read filesystem paths, or configure independent content source loaders outside of the centralized source loader interface.
