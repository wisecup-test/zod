...
1. MUST_NOT: Custom string transformations and regular expressions MUST_NOT be used to parse or modify document abstract syntax trees outside of the remark plugin lifecycle.

## Policy Block

- MUST_NOT Custom string transformations and regular expressions MUST_NOT be used to parse or modify document abstract syntax trees outside of the remark plugin lifecycle.
