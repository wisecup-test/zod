...
1. MUST: Client components performing side effects, asynchronous browser operations, or event listener subscriptions MUST encapsulate them within the useEffect hook with explicit dependency arrays.

## Policy Block

- MUST Client components performing side effects, asynchronous browser operations, or event listener subscriptions MUST encapsulate them within the useEffect hook with explicit dependency arrays.
