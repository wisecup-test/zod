...
1. MUST_NOT: Components MUST NOT use unmanaged anchor elements for local intra-application paths.

## Policy Block

- MUST_NOT Components MUST NOT use unmanaged anchor elements for local intra-application paths.
