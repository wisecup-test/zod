...
1. MUST: Documentation source loaders MUST consume unified source definitions established through the centralized configuration module rather than declaring independent file-system schemas.

## Policy Block

- MUST Documentation source loaders MUST consume unified source definitions established through the centralized configuration module rather than declaring independent file-system schemas.
