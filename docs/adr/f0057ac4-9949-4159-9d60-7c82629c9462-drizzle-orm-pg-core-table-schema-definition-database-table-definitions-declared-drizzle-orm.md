...
1. MUST: Database table definitions MUST be declared using the drizzle-orm/pg-core schema definition interface.

## Policy Block

- MUST Database table definitions MUST be declared using the drizzle-orm/pg-core schema definition interface.
