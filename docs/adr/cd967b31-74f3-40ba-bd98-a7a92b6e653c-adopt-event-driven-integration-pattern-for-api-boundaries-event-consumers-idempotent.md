...
1. SHOULD: Event consumers SHOULD be idempotent to handle duplicate message delivery

## Policy Block

- SHOULD Event consumers SHOULD be idempotent to handle duplicate message delivery
