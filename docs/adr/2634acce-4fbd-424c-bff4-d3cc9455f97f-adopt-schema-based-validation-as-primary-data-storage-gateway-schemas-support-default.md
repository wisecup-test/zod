...
1. SHOULD: Schemas SHOULD support default values, descriptions, and JSON schema conversion for interoperability

## Policy Block

- SHOULD Schemas SHOULD support default values, descriptions, and JSON schema conversion for interoperability
