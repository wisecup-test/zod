...
1. MUST: All documentation routes, content rendering views, search endpoints, and plain text extractors MUST access content collections, metadata, and page trees exclusively through the @/loaders/source internal module.

## Policy Block

- MUST All documentation routes, content rendering views, search endpoints, and plain text extractors MUST access content collections, metadata, and page trees exclusively through the @/loaders/source internal module.
