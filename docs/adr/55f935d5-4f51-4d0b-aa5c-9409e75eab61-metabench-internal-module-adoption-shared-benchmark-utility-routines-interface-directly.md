...
1. MUST: All shared benchmark utility routines MUST interface directly with the standardized harness lifecycle hooks rather than defining independent timer mechanisms.

## Policy Block

- MUST All shared benchmark utility routines MUST interface directly with the standardized harness lifecycle hooks rather than defining independent timer mechanisms.
