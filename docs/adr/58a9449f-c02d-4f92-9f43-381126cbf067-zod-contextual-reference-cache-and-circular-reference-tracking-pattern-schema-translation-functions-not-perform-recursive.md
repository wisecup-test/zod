...
1. MUST_NOT: Schema translation functions MUST NOT perform recursive reference expansion without querying and updating the contextual cache via ctx.refs.set.

## Policy Block

- MUST_NOT Schema translation functions MUST NOT perform recursive reference expansion without querying and updating the contextual cache via ctx.refs.set.
