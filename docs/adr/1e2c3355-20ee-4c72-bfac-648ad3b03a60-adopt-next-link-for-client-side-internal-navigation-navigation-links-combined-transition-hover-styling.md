...
1. MAY: Navigation links MAY be combined with transition or hover styling classes to indicate interactive state.

## Policy Block

- MAY Navigation links MAY be combined with transition or hover styling classes to indicate interactive state.
