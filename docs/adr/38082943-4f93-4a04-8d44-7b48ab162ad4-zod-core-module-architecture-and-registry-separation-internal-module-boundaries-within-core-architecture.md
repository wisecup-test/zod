...
1. MUST: Internal module boundaries within the core architecture MUST maintain unidirectional dependency flows from utility and error foundations toward parsing engines and check pipelines.

## Policy Block

- MUST Internal module boundaries within the core architecture MUST maintain unidirectional dependency flows from utility and error foundations toward parsing engines and check pipelines.
