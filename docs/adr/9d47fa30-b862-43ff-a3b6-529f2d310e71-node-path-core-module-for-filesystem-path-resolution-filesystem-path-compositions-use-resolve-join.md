...
1. MUST: Filesystem path compositions MUST use the resolve or join APIs from node:path to ensure deterministic, cross-platform path construction.

## Policy Block

- MUST Filesystem path compositions MUST use the resolve or join APIs from node:path to ensure deterministic, cross-platform path construction.
