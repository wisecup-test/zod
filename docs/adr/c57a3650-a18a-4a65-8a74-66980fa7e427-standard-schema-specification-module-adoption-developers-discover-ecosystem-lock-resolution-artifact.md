...
1. MUST: Developers MUST discover the ecosystem lock resolution artifact and verify the exact resolved version of all external specification and library dependencies before implementation.

## Policy Block

- MUST Developers MUST discover the ecosystem lock resolution artifact and verify the exact resolved version of all external specification and library dependencies before implementation.
