...
1. MAY: Synchronous request-response patterns MAY be used within bounded contexts but not across integration boundaries

## Policy Block

- MAY Synchronous request-response patterns MAY be used within bounded contexts but not across integration boundaries
