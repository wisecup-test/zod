...
1. MUST: Route layout modules responsible for documentation and content presentation MUST adopt standardized layout components from the fumadocs-ui library rather than constructing bespoke navigation chrome.

## Policy Block

- MUST Route layout modules responsible for documentation and content presentation MUST adopt standardized layout components from the fumadocs-ui library rather than constructing bespoke navigation chrome.
