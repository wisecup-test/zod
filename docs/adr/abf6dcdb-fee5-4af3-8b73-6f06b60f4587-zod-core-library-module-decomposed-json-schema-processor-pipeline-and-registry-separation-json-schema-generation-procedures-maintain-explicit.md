...
1. MUST: JSON schema generation procedures MUST maintain an explicit traversal context containing a visited cache to register visited schema instances and prevent infinite recursion during cycle resolution.

## Policy Block

- MUST JSON schema generation procedures MUST maintain an explicit traversal context containing a visited cache to register visited schema instances and prevent infinite recursion during cycle resolution.
