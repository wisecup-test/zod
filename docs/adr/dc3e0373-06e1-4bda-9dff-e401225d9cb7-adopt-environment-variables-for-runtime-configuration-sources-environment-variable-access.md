...
1. SHOULD: Environment variable access SHOULD be centralized in configuration modules or at component initialization

## Policy Block

- SHOULD Environment variable access SHOULD be centralized in configuration modules or at component initialization
