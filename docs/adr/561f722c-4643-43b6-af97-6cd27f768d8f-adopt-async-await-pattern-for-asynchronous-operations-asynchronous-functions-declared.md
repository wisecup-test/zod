...
1. MUST: All asynchronous functions MUST be declared using the async keyword and return Promise types

## Policy Block

- MUST All asynchronous functions MUST be declared using the async keyword and return Promise types
