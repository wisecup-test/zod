# Adopt Async/Await Pattern for Asynchronous Operations: Parallel Async Operations
...
1. MAY: Parallel async operations MAY use Promise.all() or Promise.allSettled() with await for concurrent execution

## Policy Block

- MAY Parallel async operations MAY use Promise.all() or Promise.allSettled() with await for concurrent execution
