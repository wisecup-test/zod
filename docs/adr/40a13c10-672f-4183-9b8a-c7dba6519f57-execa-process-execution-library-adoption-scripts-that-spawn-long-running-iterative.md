...
1. MUST: Scripts that spawn long-running, iterative, or concurrent child processes MUST register interruption signal handlers to terminate active child processes before exiting the parent process.

## Policy Block

- MUST Scripts that spawn long-running, iterative, or concurrent child processes MUST register interruption signal handlers to terminate active child processes before exiting the parent process.
