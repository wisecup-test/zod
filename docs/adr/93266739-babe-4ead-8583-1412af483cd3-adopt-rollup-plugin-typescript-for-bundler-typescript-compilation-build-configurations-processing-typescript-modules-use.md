...
1. MUST: Build configurations processing TypeScript modules MUST use @rollup/plugin-typescript to execute source compilation and emit bundled module artifacts.

## Policy Block

- MUST Build configurations processing TypeScript modules MUST use @rollup/plugin-typescript to execute source compilation and emit bundled module artifacts.
