...
1. SHOULD: Warning conditions that do not halt execution SHOULD be logged to console.warn to distinguish them from errors and informational messages

## Policy Block

- SHOULD Warning conditions that do not halt execution SHOULD be logged to console.warn to distinguish them from errors and informational messages
