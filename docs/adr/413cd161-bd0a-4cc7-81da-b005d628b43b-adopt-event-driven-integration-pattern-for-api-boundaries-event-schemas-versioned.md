...
1. MUST: Event schemas MUST be versioned and backward-compatible to enable independent deployment

## Policy Block

- MUST Event schemas MUST be versioned and backward-compatible to enable independent deployment
