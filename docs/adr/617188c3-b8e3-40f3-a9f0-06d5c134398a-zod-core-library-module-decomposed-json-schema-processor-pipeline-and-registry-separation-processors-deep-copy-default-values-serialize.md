# Zod Core Library Module: Decomposed JSON Schema Processor Pipeline and Registry Separation: Processors Deep Copy Default Values Serialize
...
1. MAY: Processors MAY deep-copy default values and serialize intermediate property representations using isolated transformation passes to ensure immutability of original definitions.

## Policy Block

- MAY Processors MAY deep-copy default values and serialize intermediate property representations using isolated transformation passes to ensure immutability of original definitions.
