...
1. MUST: Consumers MUST inspect the repository dependency resolution lock artifact to identify the authoritative version of lucide-react and ensure all icon symbol imports align with the resolved version exported interface.

## Policy Block

- MUST Consumers MUST inspect the repository dependency resolution lock artifact to identify the authoritative version of lucide-react and ensure all icon symbol imports align with the resolved version exported interface.
