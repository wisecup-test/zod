...
1. MUST: Interactive UI components requiring stateful interactions or lifecycle side effects MUST declare the client rendering boundary and use React hooks exclusively for state and side-effect management.

## Policy Block

- MUST Interactive UI components requiring stateful interactions or lifecycle side effects MUST declare the client rendering boundary and use React hooks exclusively for state and side-effect management.
