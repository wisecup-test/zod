...
1. SHOULD: Document transformation pipelines requiring AST manipulation for external consumers SHOULD compose middleware plugins directly against the loaded source AST representation prior to serialization.

## Policy Block

- SHOULD Document transformation pipelines requiring AST manipulation for external consumers SHOULD compose middleware plugins directly against the loaded source AST representation prior to serialization.
