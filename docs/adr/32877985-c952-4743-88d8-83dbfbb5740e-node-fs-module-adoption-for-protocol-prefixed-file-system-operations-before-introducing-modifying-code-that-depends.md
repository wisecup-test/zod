...
1. MUST: Before introducing or modifying code that depends on versioned dependencies, consumers MUST inspect the repository lock artifact to verify the exact resolved version against documented API specifications.

## Policy Block

- MUST Before introducing or modifying code that depends on versioned dependencies, consumers MUST inspect the repository lock artifact to verify the exact resolved version against documented API specifications.
