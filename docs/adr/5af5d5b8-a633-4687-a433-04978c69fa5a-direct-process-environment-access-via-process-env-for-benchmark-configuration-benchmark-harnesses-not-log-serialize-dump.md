...
1. MUST_NOT: Benchmark harnesses MUST_NOT log, serialize, or dump raw ambient environment dictionaries or unredacted execution contexts to console outputs, benchmark summary tables, or artifact stores.

## Policy Block

- MUST_NOT Benchmark harnesses MUST_NOT log, serialize, or dump raw ambient environment dictionaries or unredacted execution contexts to console outputs, benchmark summary tables, or artifact stores.
