...
1. MUST: When consuming or extending versioned library dependencies, the consumer MUST inspect the authoritative dependency lock artifact to determine the exact resolved dependency version prior to implementation.

## Policy Block

- MUST When consuming or extending versioned library dependencies, the consumer MUST inspect the authoritative dependency lock artifact to determine the exact resolved dependency version prior to implementation.
