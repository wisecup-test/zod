...
1. MUST_NOT: Raw, unvalidated data MUST NOT be persisted to primary datastores without schema validation

## Policy Block

- MUST_NOT Raw, unvalidated data MUST NOT be persisted to primary datastores without schema validation
