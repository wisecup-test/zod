...
1. SHOULD: Interactive icon triggers SHOULD provide accessible label alternatives or parent element aria attributes when an icon component is rendered without accompanying descriptive text.

## Policy Block

- SHOULD Interactive icon triggers SHOULD provide accessible label alternatives or parent element aria attributes when an icon component is rendered without accompanying descriptive text.
