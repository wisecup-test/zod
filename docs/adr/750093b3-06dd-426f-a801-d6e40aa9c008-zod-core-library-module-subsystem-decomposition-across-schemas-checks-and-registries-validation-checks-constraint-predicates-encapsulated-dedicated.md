...
1. MUST: Validation checks and constraint predicates MUST be encapsulated in the dedicated checks module, isolating evaluation logic from schema type definition structures.

## Policy Block

- MUST Validation checks and constraint predicates MUST be encapsulated in the dedicated checks module, isolating evaluation logic from schema type definition structures.
