...
1. MUST: Hierarchical documentation routes requiring structured tree navigation, sidebar items, and table of contents components MUST consume documentation layout primitives from fumadocs-ui/layouts/docs.

## Policy Block

- MUST Hierarchical documentation routes requiring structured tree navigation, sidebar items, and table of contents components MUST consume documentation layout primitives from fumadocs-ui/layouts/docs.
