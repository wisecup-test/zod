...
1. MUST_NOT: Render unoptimized native HTML image elements for documentation assets where the standardized image component is applicable.

## Policy Block

- MUST_NOT Render unoptimized native HTML image elements for documentation assets where the standardized image component is applicable.
