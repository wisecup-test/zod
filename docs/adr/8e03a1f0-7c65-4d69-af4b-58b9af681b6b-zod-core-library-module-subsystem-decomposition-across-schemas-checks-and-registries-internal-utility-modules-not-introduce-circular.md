# Zod Core Library Module: Subsystem Decomposition Across Schemas, Checks, and Registries: Internal Utility Modules Not Introduce Circular
...
1. MUST_NOT: Internal utility modules MUST NOT introduce circular runtime dependencies between schema compilation primitives and downstream parsing routines.

## Policy Block

- MUST_NOT Internal utility modules MUST NOT introduce circular runtime dependencies between schema compilation primitives and downstream parsing routines.
