...
1. MUST: Event producers MUST NOT have direct dependencies on event consumer implementations

## Policy Block

- MUST Event producers MUST NOT have direct dependencies on event consumer implementations
