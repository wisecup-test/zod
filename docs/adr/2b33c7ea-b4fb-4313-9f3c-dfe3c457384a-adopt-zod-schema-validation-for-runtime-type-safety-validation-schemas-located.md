...
1. SHOULD: Validation schemas SHOULD be co-located with their corresponding API endpoints or data models for maintainability

## Policy Block

- SHOULD Validation schemas SHOULD be co-located with their corresponding API endpoints or data models for maintainability
