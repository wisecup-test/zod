...
1. SHOULD: Localized error formatters SHOULD rely on shared utility helpers for input inspection and type representation rather than implementing custom type checking.

## Policy Block

- SHOULD Localized error formatters SHOULD rely on shared utility helpers for input inspection and type representation rather than implementing custom type checking.
