...
1. SHOULD: Functions that call async operations SHOULD themselves be declared as async to maintain consistency

## Policy Block

- SHOULD Functions that call async operations SHOULD themselves be declared as async to maintain consistency
