...
1. SHOULD: External API clients SHOULD manage query frequency and response durability by maintaining explicit cache layers and timed revalidation policies.

## Policy Block

- SHOULD External API clients SHOULD manage query frequency and response durability by maintaining explicit cache layers and timed revalidation policies.
