...
1. MUST: When integrating versioned third-party or workspace dependencies, the consumer MUST inspect repository lock or resolution artifacts to verify the authoritative resolved version before implementation.

## Policy Block

- MUST When integrating versioned third-party or workspace dependencies, the consumer MUST inspect repository lock or resolution artifacts to verify the authoritative resolved version before implementation.
