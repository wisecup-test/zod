...
1. MUST_NOT: Developers MUST NOT use manual string concatenation or hardcoded directory separators to construct filesystem paths.

## Policy Block

- MUST_NOT Developers MUST NOT use manual string concatenation or hardcoded directory separators to construct filesystem paths.
