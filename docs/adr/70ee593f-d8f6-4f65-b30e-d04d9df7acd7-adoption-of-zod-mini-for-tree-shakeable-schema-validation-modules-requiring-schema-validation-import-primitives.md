...
1. MUST: Modules requiring schema validation MUST import validation primitives and schema builders directly from the zod/mini module entry point.

## Policy Block

- MUST Modules requiring schema validation MUST import validation primitives and schema builders directly from the zod/mini module entry point.
