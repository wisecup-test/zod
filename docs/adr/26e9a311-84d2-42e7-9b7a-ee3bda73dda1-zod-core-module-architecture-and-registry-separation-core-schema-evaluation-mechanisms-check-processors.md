# Zod Core Module Architecture and Registry Separation: Core Schema Evaluation Mechanisms Check Processors
...
1. MUST: All core schema evaluation mechanisms, check processors, and error collection utilities MUST reside within the decoupled core engine module, isolating foundational schema mechanics from compatibility interfaces and external serializers.

## Policy Block

- MUST All core schema evaluation mechanisms, check processors, and error collection utilities MUST reside within the decoupled core engine module, isolating foundational schema mechanics from compatibility interfaces and external serializers.
