...
1. MUST: Data structures processed across external or untrusted boundaries MUST be defined using zod schemas.

## Policy Block

- MUST Data structures processed across external or untrusted boundaries MUST be defined using zod schemas.
