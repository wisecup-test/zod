...
1. MUST: Documentation content sources and loader pipelines MUST define and consume their content configuration using the fumadocs-mdx/config module.

## Policy Block

- MUST Documentation content sources and loader pipelines MUST define and consume their content configuration using the fumadocs-mdx/config module.
