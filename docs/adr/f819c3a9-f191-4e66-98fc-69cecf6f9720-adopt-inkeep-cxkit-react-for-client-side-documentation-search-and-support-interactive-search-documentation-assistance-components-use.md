...
1. MUST: Interactive search and documentation assistance components MUST use @inkeep/cxkit-react for client-side search and chat widgets.

## Policy Block

- MUST Interactive search and documentation assistance components MUST use @inkeep/cxkit-react for client-side search and chat widgets.
