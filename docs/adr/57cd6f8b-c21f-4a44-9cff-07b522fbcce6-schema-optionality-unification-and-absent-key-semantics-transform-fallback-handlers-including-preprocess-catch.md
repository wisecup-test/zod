...
1. MUST: Transform and fallback handlers, including z.preprocess, catch, and default configurations, MUST evaluate within the inner schema context before outer optionality resolution short-circuits execution.

## Policy Block

- MUST Transform and fallback handlers, including z.preprocess, catch, and default configurations, MUST evaluate within the inner schema context before outer optionality resolution short-circuits execution.
