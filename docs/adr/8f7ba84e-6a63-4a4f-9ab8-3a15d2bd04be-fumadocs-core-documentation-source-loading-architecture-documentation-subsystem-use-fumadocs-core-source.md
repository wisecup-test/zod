...
1. MUST: The documentation subsystem MUST use fumadocs-core/source as the authoritative abstraction for loading, indexing, and traversing documentation collections.

## Policy Block

- MUST The documentation subsystem MUST use fumadocs-core/source as the authoritative abstraction for loading, indexing, and traversing documentation collections.
