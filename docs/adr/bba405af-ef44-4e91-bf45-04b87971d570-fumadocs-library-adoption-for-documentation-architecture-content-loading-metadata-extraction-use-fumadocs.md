...
1. MUST: Content loading and metadata extraction MUST use `fumadocs-core/source` and `fumadocs-mdx` rather than ad-hoc file-system traversal or custom content parsers.

## Policy Block

- MUST Content loading and metadata extraction MUST use `fumadocs-core/source` and `fumadocs-mdx` rather than ad-hoc file-system traversal or custom content parsers.
