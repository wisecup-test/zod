...
1. MUST: Package-level test configurations MUST use mergeConfig to extend the shared root test configuration rather than redefining shared test runner environment settings independently.

## Policy Block

- MUST Package-level test configurations MUST use mergeConfig to extend the shared root test configuration rather than redefining shared test runner environment settings independently.
