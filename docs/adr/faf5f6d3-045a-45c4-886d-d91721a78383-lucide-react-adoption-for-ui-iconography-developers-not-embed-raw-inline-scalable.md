...
1. MUST_NOT: Developers MUST_NOT embed raw inline scalable vector graphic markup or introduce alternative third-party icon packages for interface glyphs within the documentation subsystem.

## Policy Block

- MUST_NOT Developers MUST_NOT embed raw inline scalable vector graphic markup or introduce alternative third-party icon packages for interface glyphs within the documentation subsystem.
