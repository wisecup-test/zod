...
1. MAY: Schemas MAY provide custom locale messages within individual constraint functions to satisfy localized error requirements.

## Policy Block

- MAY Schemas MAY provide custom locale messages within individual constraint functions to satisfy localized error requirements.
