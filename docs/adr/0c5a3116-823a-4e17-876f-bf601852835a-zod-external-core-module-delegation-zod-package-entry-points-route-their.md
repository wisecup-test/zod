...
1. MUST: All Zod package entry points MUST route their core public API definitions and runtime constructs through the centralized external core module rather than maintaining independent core implementations.

## Policy Block

- MUST All Zod package entry points MUST route their core public API definitions and runtime constructs through the centralized external core module rather than maintaining independent core implementations.
