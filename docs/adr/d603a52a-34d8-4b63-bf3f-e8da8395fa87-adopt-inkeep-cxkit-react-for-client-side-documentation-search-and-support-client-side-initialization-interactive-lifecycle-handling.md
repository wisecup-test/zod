...
1. MUST: Client-side initialization and interactive lifecycle handling for @inkeep/cxkit-react integrations MUST be coordinated within useEffect hooks.

## Policy Block

- MUST Client-side initialization and interactive lifecycle handling for @inkeep/cxkit-react integrations MUST be coordinated within useEffect hooks.
