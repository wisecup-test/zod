...
1. SHOULD: Documentation processing and transformation pipelines SHOULD consume source tree nodes and page metadata directly from the source loader abstraction.

## Policy Block

- SHOULD Documentation processing and transformation pipelines SHOULD consume source tree nodes and page metadata directly from the source loader abstraction.
