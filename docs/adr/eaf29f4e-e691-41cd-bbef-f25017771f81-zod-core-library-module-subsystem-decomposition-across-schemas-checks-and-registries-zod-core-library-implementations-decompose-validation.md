...
1. MUST: Zod Core library implementations MUST decompose validation runtime primitives into dedicated internal modules separating schema definitions, check assertions, error tracking, registry metadata, parsing routines, and standard schema interoperability.

## Policy Block

- MUST Zod Core library implementations MUST decompose validation runtime primitives into dedicated internal modules separating schema definitions, check assertions, error tracking, registry metadata, parsing routines, and standard schema interoperability.
