...
1. MUST_NOT: Core validation execution modules MUST_NOT depend on outer compatibility facades, peripheral format converters, or consumer-facing legacy shims.

## Policy Block

- MUST_NOT Core validation execution modules MUST_NOT depend on outer compatibility facades, peripheral format converters, or consumer-facing legacy shims.
