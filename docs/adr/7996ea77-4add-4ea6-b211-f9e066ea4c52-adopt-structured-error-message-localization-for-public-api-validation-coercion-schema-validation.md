...
1. MUST: Coercion and schema validation logic MUST be separated into distinct modules to maintain clear API boundaries

## Policy Block

- MUST Coercion and schema validation logic MUST be separated into distinct modules to maintain clear API boundaries
