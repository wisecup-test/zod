...
1. MUST: Consumers MUST inspect the repository lock or resolution artifact to determine and adhere to the exact resolved version of the benchmark library prior to implementation.

## Policy Block

- MUST Consumers MUST inspect the repository lock or resolution artifact to determine and adhere to the exact resolved version of the benchmark library prior to implementation.
