...
1. MUST: Consumers MUST discover the project dependency manifest and lock artifact to determine the authoritative installed version of the validation library prior to implementing or consuming schema primitives.

## Policy Block

- MUST Consumers MUST discover the project dependency manifest and lock artifact to determine the authoritative installed version of the validation library prior to implementing or consuming schema primitives.
