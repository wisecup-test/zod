...
1. MUST: Before integrating or referencing any versioned dependency in benchmark suites, consumers MUST inspect the repository lock artifact to verify the exact resolved version against authorized dependency ranges.

## Policy Block

- MUST Before integrating or referencing any versioned dependency in benchmark suites, consumers MUST inspect the repository lock artifact to verify the exact resolved version against authorized dependency ranges.
