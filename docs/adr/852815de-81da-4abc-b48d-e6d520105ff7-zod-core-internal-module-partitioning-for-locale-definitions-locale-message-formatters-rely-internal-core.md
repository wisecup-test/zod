...
1. SHOULD: Locale message formatters SHOULD rely on internal core utility helpers for text interpolation and value serialization rather than introducing disparate helper utilities.

## Policy Block

- SHOULD Locale message formatters SHOULD rely on internal core utility helpers for text interpolation and value serialization rather than introducing disparate helper utilities.
