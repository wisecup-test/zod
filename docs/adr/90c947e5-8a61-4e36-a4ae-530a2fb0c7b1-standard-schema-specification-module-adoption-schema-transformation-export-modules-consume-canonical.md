...
1. MUST: Schema transformation and export modules MUST consume the canonical schema registry and core schema definitions alongside the Standard Schema module to preserve metadata fidelity.

## Policy Block

- MUST Schema transformation and export modules MUST consume the canonical schema registry and core schema definitions alongside the Standard Schema module to preserve metadata fidelity.
