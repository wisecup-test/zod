...
1. MUST: Global state and schema registries MUST be instantiated and managed within the core module, exposing access solely through core registry interfaces rather than distribution-local registries.

## Policy Block

- MUST Global state and schema registries MUST be instantiated and managed within the core module, exposing access solely through core registry interfaces rather than distribution-local registries.
