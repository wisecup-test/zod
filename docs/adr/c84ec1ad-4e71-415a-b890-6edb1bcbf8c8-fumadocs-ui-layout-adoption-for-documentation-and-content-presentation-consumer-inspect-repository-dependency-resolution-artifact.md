...
1. MUST: The consumer MUST inspect the repository dependency resolution artifact to determine the exact resolved version of the layout library before calling its export interfaces.

## Policy Block

- MUST The consumer MUST inspect the repository dependency resolution artifact to determine the exact resolved version of the layout library before calling its export interfaces.
