...
1. SHOULD: Schema definitions SHOULD be co-located with service interface definitions to maintain cohesion

## Policy Block

- SHOULD Schema definitions SHOULD be co-located with service interface definitions to maintain cohesion
