...
1. SHOULD: Benchmark suites SHOULD sort completed benchmark results by throughput to compute relative performance ratios against the baseline slowest implementation.

## Policy Block

- SHOULD Benchmark suites SHOULD sort completed benchmark results by throughput to compute relative performance ratios against the baseline slowest implementation.
