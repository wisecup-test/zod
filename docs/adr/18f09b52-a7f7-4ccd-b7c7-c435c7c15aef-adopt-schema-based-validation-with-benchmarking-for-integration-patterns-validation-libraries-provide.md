...
1. SHOULD: Validation libraries SHOULD provide multiple implementation variants (mini, classic, core) to support different performance and feature requirements

## Policy Block

- SHOULD Validation libraries SHOULD provide multiple implementation variants (mini, classic, core) to support different performance and feature requirements
