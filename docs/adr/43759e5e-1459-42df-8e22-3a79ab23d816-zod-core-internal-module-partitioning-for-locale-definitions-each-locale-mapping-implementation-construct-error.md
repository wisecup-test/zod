...
1. MUST: Each locale mapping implementation MUST construct error issue representations using only the standardized error definitions and check descriptors provided by the internal core submodules.

## Policy Block

- MUST Each locale mapping implementation MUST construct error issue representations using only the standardized error definitions and check descriptors provided by the internal core submodules.
