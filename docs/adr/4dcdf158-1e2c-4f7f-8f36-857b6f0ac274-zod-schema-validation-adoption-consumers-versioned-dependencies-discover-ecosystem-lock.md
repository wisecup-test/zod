...
1. MUST: Consumers of versioned dependencies MUST discover the ecosystem lock file and verify the exact resolved version before implementation.

## Policy Block

- MUST Consumers of versioned dependencies MUST discover the ecosystem lock file and verify the exact resolved version before implementation.
