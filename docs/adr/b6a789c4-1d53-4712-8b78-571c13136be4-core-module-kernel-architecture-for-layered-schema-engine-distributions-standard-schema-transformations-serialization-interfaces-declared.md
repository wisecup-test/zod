...
1. SHOULD: Standard schema transformations and serialization interfaces SHOULD be declared within the core module to guarantee behavioral parity across all distribution variants.

## Policy Block

- SHOULD Standard schema transformations and serialization interfaces SHOULD be declared within the core module to guarantee behavioral parity across all distribution variants.
