...
1. MUST: Consumers MUST verify the project dependency lock artifact to determine the exact resolved version of React before implementing client interaction hooks.

## Policy Block

- MUST Consumers MUST verify the project dependency lock artifact to determine the exact resolved version of React before implementing client interaction hooks.
