...
1. MAY: Schemas MAY include transformation logic (coercion, normalization) when appropriate for the service boundary

## Policy Block

- MAY Schemas MAY include transformation logic (coercion, normalization) when appropriate for the service boundary
