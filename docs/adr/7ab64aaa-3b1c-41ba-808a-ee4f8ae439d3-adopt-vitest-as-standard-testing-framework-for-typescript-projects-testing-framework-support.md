...
1. MUST: Testing framework MUST support native TypeScript execution without requiring separate compilation steps

## Policy Block

- MUST Testing framework MUST support native TypeScript execution without requiring separate compilation steps
