...
1. MUST: The core library architecture MUST isolate target serialization pipelines into distinct processor modules separated from base schema definitions and validation check structures.

## Policy Block

- MUST The core library architecture MUST isolate target serialization pipelines into distinct processor modules separated from base schema definitions and validation check structures.
