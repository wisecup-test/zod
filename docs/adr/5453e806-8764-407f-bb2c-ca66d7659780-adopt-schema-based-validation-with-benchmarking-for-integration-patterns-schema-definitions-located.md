...
1. SHOULD: Schema definitions SHOULD be co-located with their corresponding benchmark tests to facilitate performance regression detection

## Policy Block

- SHOULD Schema definitions SHOULD be co-located with their corresponding benchmark tests to facilitate performance regression detection
