...
1. MUST: Type definitions for async functions MUST explicitly declare Promise return types with appropriate generic parameters

## Policy Block

- MUST Type definitions for async functions MUST explicitly declare Promise return types with appropriate generic parameters
