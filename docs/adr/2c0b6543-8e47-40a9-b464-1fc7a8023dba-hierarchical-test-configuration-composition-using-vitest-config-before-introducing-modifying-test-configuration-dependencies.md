...
1. MUST: Before introducing or modifying test configuration dependencies, engineers MUST discover the repository lock artifact and verify the exact resolved version against the dependency manifest.

## Policy Block

- MUST Before introducing or modifying test configuration dependencies, engineers MUST discover the repository lock artifact and verify the exact resolved version against the dependency manifest.
