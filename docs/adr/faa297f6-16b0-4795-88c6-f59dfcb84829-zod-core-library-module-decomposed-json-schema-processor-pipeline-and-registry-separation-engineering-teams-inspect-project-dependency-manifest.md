...
1. MUST: Engineering teams MUST inspect the project dependency manifest and resolve the exact locked version from the authoritative repository resolution artifact before implementing or modifying module integrations.

## Policy Block

- MUST Engineering teams MUST inspect the project dependency manifest and resolve the exact locked version from the authoritative repository resolution artifact before implementing or modifying module integrations.
