...
1. MUST: Before introducing or modifying dependencies related to schema transformation modules, the consumer MUST inspect the project lock artifact to resolve the authoritative pinned dependency versions.

## Policy Block

- MUST Before introducing or modifying dependencies related to schema transformation modules, the consumer MUST inspect the project lock artifact to resolve the authoritative pinned dependency versions.
