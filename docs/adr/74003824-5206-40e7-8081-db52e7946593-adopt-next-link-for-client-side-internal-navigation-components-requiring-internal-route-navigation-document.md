...
1. MUST: Components requiring internal route navigation or document anchor links MUST use the Link component provided by next/link rather than standard unmanaged hyperlink elements.

## Policy Block

- MUST Components requiring internal route navigation or document anchor links MUST use the Link component provided by next/link rather than standard unmanaged hyperlink elements.
