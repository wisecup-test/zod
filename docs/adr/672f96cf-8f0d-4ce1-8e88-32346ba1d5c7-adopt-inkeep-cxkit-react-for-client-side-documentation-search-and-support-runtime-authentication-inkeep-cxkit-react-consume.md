...
1. MUST: Runtime authentication for @inkeep/cxkit-react MUST consume configuration exclusively through process.env.NEXT_PUBLIC_INKEEP_KEY.

## Policy Block

- MUST Runtime authentication for @inkeep/cxkit-react MUST consume configuration exclusively through process.env.NEXT_PUBLIC_INKEEP_KEY.
