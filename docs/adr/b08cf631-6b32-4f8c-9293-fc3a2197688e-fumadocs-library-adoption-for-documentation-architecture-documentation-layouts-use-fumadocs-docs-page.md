...
1. MUST: Documentation layouts MUST use `fumadocs-ui/layouts/docs` for documentation page hierarchies and `fumadocs-ui/layouts/home` for index and landing views to maintain uniform navigation structures.

## Policy Block

- MUST Documentation layouts MUST use `fumadocs-ui/layouts/docs` for documentation page hierarchies and `fumadocs-ui/layouts/home` for index and landing views to maintain uniform navigation structures.
