...
1. MUST_NOT: Internal core modules MUST NOT introduce circular module dependencies between schema declarations, parsing routines, and public API factories.

## Policy Block

- MUST_NOT Internal core modules MUST NOT introduce circular module dependencies between schema declarations, parsing routines, and public API factories.
