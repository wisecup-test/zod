...
1. MUST: Before implementing or updating any benchmark execution dependency, the consumer MUST inspect the repository dependency lock artifact to determine and verify the exact resolved version.

## Policy Block

- MUST Before implementing or updating any benchmark execution dependency, the consumer MUST inspect the repository dependency lock artifact to determine and verify the exact resolved version.
