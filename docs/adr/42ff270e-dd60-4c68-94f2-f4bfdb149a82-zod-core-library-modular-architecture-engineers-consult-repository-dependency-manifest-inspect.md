...
1. MUST: Engineers MUST consult the repository dependency manifest and inspect the authoritative lock artifact to determine the exact resolved dependency versions prior to integrating or modifying external standard specifications or library interfaces.

## Policy Block

- MUST Engineers MUST consult the repository dependency manifest and inspect the authoritative lock artifact to determine the exact resolved dependency versions prior to integrating or modifying external standard specifications or library interfaces.
