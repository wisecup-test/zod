...
1. MUST: Table definitions MUST declare primary key constraints using dedicated column builder functions provided by drizzle-orm/pg-core.

## Policy Block

- MUST Table definitions MUST declare primary key constraints using dedicated column builder functions provided by drizzle-orm/pg-core.
