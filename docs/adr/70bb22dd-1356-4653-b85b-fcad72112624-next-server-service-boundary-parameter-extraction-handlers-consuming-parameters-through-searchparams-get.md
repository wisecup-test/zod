...
1. MUST: Handlers consuming parameters through searchParams.get MUST explicitly account for null or missing return values by supplying fallback defaults or returning structured error responses at the service boundary.

## Policy Block

- MUST Handlers consuming parameters through searchParams.get MUST explicitly account for null or missing return values by supplying fallback defaults or returning structured error responses at the service boundary.
