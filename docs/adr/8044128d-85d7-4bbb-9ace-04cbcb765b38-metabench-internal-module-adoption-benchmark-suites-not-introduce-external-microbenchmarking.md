...
1. MUST_NOT: Benchmark suites MUST NOT introduce external microbenchmarking runners or ad-hoc timing loops that bypass the internal metabench harness interface.

## Policy Block

- MUST_NOT Benchmark suites MUST NOT introduce external microbenchmarking runners or ad-hoc timing loops that bypass the internal metabench harness interface.
