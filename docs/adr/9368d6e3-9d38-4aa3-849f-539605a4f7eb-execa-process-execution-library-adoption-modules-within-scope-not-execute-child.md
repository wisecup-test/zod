...
1. MUST_NOT: Modules within scope MUST_NOT execute child processes using unmanaged shell strings or untracked background processes that bypass interruption signal cleanup.

## Policy Block

- MUST_NOT Modules within scope MUST_NOT execute child processes using unmanaged shell strings or untracked background processes that bypass interruption signal cleanup.
