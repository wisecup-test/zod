...
1. MUST: Application components that interact with route state, navigate programmatically, or access search parameters MUST import navigation primitives exclusively from next/navigation.

## Policy Block

- MUST Application components that interact with route state, navigate programmatically, or access search parameters MUST import navigation primitives exclusively from next/navigation.
