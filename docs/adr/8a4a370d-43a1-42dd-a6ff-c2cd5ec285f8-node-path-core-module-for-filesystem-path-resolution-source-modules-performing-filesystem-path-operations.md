...
1. MUST: Source modules performing filesystem path operations MUST import filesystem utilities using the explicit node:path module specifier rather than un-prefixed module identifiers.

## Policy Block

- MUST Source modules performing filesystem path operations MUST import filesystem utilities using the explicit node:path module specifier rather than un-prefixed module identifiers.
