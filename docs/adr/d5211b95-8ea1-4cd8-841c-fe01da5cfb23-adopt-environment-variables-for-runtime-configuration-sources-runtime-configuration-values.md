...
1. MUST: Runtime configuration values that vary by environment MUST be sourced from environment variables using process.env

## Policy Block

- MUST Runtime configuration values that vary by environment MUST be sourced from environment variables using process.env
