...
1. SHOULD: Route handlers and presentation components SHOULD consume pre-aggregated source collections and tree structures exposed by the source loader module rather than performing ad-hoc content filtering or tree transformations.

## Policy Block

- SHOULD Route handlers and presentation components SHOULD consume pre-aggregated source collections and tree structures exposed by the source loader module rather than performing ad-hoc content filtering or tree transformations.
