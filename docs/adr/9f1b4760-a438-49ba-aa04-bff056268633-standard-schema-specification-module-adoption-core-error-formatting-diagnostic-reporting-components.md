...
1. MUST: Core error formatting and diagnostic reporting components MUST align error output representations with the specifications defined in the Standard Schema module.

## Policy Block

- MUST Core error formatting and diagnostic reporting components MUST align error output representations with the specifications defined in the Standard Schema module.
