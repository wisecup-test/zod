...
1. MUST: Extracted parameter values passed into dynamic downstream generation or layout rendering MUST undergo type validation and character sanitization prior to consumption.

## Policy Block

- MUST Extracted parameter values passed into dynamic downstream generation or layout rendering MUST undergo type validation and character sanitization prior to consumption.
