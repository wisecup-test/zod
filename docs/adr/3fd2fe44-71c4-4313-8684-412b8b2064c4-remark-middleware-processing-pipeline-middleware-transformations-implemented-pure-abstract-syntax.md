...
1. SHOULD: Middleware transformations SHOULD be implemented as pure abstract syntax tree visitor plugins to ensure deterministic serialization.

## Policy Block

- SHOULD Middleware transformations SHOULD be implemented as pure abstract syntax tree visitor plugins to ensure deterministic serialization.
