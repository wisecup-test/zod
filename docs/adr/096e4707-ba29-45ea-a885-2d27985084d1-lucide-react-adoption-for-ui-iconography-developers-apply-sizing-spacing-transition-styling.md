...
1. SHOULD: Developers SHOULD apply sizing, spacing, and transition styling to icon components through unified design system token class bindings rather than hardcoded inline style attributes.

## Policy Block

- SHOULD Developers SHOULD apply sizing, spacing, and transition styling to icon components through unified design system token class bindings rather than hardcoded inline style attributes.
