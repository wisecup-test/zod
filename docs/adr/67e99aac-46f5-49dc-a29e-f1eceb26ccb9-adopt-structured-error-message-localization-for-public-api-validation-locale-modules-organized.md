...
1. SHOULD: Locale modules SHOULD be organized by ISO language codes (e.g., ko, pl, kh, mk) in dedicated locale directories

## Policy Block

- SHOULD Locale modules SHOULD be organized by ISO language codes (e.g., ko, pl, kh, mk) in dedicated locale directories
