...
1. MUST: Prior to implementing or modifying schema conversion modules, the engineer MUST locate the repository dependency manifest and resolution artifact to verify the exact resolved version of all supporting libraries and validate API contracts against official documentation.

## Policy Block

- MUST Prior to implementing or modifying schema conversion modules, the engineer MUST locate the repository dependency manifest and resolution artifact to verify the exact resolved version of all supporting libraries and validate API contracts against official documentation.
