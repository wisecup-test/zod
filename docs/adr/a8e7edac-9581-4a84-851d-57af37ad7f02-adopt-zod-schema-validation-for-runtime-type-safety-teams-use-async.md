...
1. MAY: Teams MAY use async refinements for validation requiring external service calls (database lookups, API checks)

## Policy Block

- MAY Teams MAY use async refinements for validation requiring external service calls (database lookups, API checks)
