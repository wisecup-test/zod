...
1. MUST: Prior to implementing changes that depend on versioned content processing or source integration libraries, developers MUST discover the dependency manifest and authoritative lock artifact to confirm the exact resolved versions and API specifications.

## Policy Block

- MUST Prior to implementing changes that depend on versioned content processing or source integration libraries, developers MUST discover the dependency manifest and authoritative lock artifact to confirm the exact resolved versions and API specifications.
