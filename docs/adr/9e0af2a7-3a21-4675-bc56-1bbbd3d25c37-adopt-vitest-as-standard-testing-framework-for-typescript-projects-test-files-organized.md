...
1. MAY: Test files MAY be organized into subdirectories within tests/ for complex packages with many test scenarios

## Policy Block

- MAY Test files MAY be organized into subdirectories within tests/ for complex packages with many test scenarios
