...
1. SHOULD: Processors SHOULD map validation checks to standardized schema validation keywords by delegating to dedicated check evaluation helpers.

## Policy Block

- SHOULD Processors SHOULD map validation checks to standardized schema validation keywords by delegating to dedicated check evaluation helpers.
