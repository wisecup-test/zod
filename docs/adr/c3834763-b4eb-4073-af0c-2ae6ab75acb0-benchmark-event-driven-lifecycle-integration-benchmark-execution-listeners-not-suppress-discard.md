...
1. MUST_NOT: Benchmark execution listeners MUST NOT suppress or discard cycle completion events during suite execution.

## Policy Block

- MUST_NOT Benchmark execution listeners MUST NOT suppress or discard cycle completion events during suite execution.
