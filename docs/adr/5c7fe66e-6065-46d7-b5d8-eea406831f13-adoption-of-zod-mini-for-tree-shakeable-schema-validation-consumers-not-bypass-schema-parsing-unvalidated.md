...
1. MUST_NOT: Consumers MUST_NOT bypass schema parsing on unvalidated external payloads prior to business domain processing.

## Policy Block

- MUST_NOT Consumers MUST_NOT bypass schema parsing on unvalidated external payloads prior to business domain processing.
