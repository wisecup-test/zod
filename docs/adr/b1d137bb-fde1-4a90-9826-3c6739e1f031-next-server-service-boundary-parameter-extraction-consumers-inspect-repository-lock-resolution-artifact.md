...
1. MUST: Consumers MUST inspect the repository lock or resolution artifact to determine and verify the exact resolved version of next/server before implementing or modifying service boundary contracts.

## Policy Block

- MUST Consumers MUST inspect the repository lock or resolution artifact to determine and verify the exact resolved version of next/server before implementing or modifying service boundary contracts.
