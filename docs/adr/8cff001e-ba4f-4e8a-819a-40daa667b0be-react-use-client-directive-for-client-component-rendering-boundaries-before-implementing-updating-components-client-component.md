...
1. MUST: Before implementing or updating components using the client component rendering model, developers MUST discover the project dependency manifest and lock artifact to inspect and verify the exact resolved version of the rendering framework and UI libraries.

## Policy Block

- MUST Before implementing or updating components using the client component rendering model, developers MUST discover the project dependency manifest and lock artifact to inspect and verify the exact resolved version of the rendering framework and UI libraries.
