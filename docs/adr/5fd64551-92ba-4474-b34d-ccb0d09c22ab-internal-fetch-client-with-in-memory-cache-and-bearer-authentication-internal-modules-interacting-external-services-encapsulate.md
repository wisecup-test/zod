...
1. MUST: Internal modules interacting with external services MUST encapsulate HTTP requests within dedicated client boundary functions rather than executing ad-hoc network queries.

## Policy Block

- MUST Internal modules interacting with external services MUST encapsulate HTTP requests within dedicated client boundary functions rather than executing ad-hoc network queries.
