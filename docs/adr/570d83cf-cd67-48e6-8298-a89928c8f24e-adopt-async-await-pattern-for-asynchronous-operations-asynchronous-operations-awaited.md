...
1. MUST: Asynchronous operations MUST be awaited using the await keyword rather than using .then() chains

## Policy Block

- MUST Asynchronous operations MUST be awaited using the await keyword rather than using .then() chains
