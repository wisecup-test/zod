...
1. MUST_NOT: Internal parsing helpers MUST NOT embed hardcoded locale-specific message templates within schema evaluation algorithms.

## Policy Block

- MUST_NOT Internal parsing helpers MUST NOT embed hardcoded locale-specific message templates within schema evaluation algorithms.
