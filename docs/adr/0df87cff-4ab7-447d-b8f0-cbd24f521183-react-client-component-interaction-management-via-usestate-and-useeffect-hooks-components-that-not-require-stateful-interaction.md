...
1. SHOULD: Components that do not require stateful interaction or lifecycle side effects SHOULD NOT declare client boundaries or use React hooks.

## Policy Block

- SHOULD Components that do not require stateful interaction or lifecycle side effects SHOULD NOT declare client boundaries or use React hooks.
