...
1. MUST: Schema definitions MUST be co-located with or directly referenced by the modules that perform datastore operations

## Policy Block

- MUST Schema definitions MUST be co-located with or directly referenced by the modules that perform datastore operations
