...
1. MUST_NOT: Downstream helper and facade modules MUST NOT instantiate or throw unstandardized error types, but MUST instantiate ZodError instances or delegate error formation directly to core error utilities.

## Policy Block

- MUST_NOT Downstream helper and facade modules MUST NOT instantiate or throw unstandardized error types, but MUST instantiate ZodError instances or delegate error formation directly to core error utilities.
