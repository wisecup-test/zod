...
1. SHOULD: Multi-value attributes SHOULD be modeled using typed array column builders rather than untyped serialized structures.

## Policy Block

- SHOULD Multi-value attributes SHOULD be modeled using typed array column builders rather than untyped serialized structures.
