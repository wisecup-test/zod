...
1. MUST: Schema translation routines MUST coordinate reference resolution through a shared context object providing memoized lookup via ctx.refs and cycle tracking via ctx.processing.

## Policy Block

- MUST Schema translation routines MUST coordinate reference resolution through a shared context object providing memoized lookup via ctx.refs and cycle tracking via ctx.processing.
