...
1. MUST: Verify the locked version of the framework dependency from the repository resolution artifact before using image component attributes or configuration properties.

## Policy Block

- MUST Verify the locked version of the framework dependency from the repository resolution artifact before using image component attributes or configuration properties.
