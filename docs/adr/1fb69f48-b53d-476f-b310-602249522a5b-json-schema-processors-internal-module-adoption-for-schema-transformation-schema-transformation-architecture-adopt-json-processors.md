...
1. MUST: The schema transformation architecture MUST adopt the json-schema-processors internal module to isolate individual schema definition conversions from top-level schema generation.

## Policy Block

- MUST The schema transformation architecture MUST adopt the json-schema-processors internal module to isolate individual schema definition conversions from top-level schema generation.
