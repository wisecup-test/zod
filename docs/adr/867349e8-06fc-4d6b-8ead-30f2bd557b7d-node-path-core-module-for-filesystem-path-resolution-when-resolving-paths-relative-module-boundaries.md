...
1. SHOULD: When resolving paths relative to module boundaries in module environments, implementations SHOULD combine the fileURLToPath API with dirname and resolve from node:path.

## Policy Block

- SHOULD When resolving paths relative to module boundaries in module environments, implementations SHOULD combine the fileURLToPath API with dirname and resolve from node:path.
