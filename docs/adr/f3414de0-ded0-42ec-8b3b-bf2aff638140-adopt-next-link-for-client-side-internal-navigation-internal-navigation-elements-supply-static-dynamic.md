...
1. SHOULD: Internal navigation elements SHOULD supply static or dynamic destination paths to the href attribute of the Link component to enable background route prefetching.

## Policy Block

- SHOULD Internal navigation elements SHOULD supply static or dynamic destination paths to the href attribute of the Link component to enable background route prefetching.
