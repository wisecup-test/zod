...
1. MUST: Modules providing runtime schema evaluation, parsing helpers, and public facades MUST import core error structures, default localization mappings, and shared foundational utilities exclusively from the centralized Zod core module rather than re-declaring error classes or formatting logic locally.

## Policy Block

- MUST Modules providing runtime schema evaluation, parsing helpers, and public facades MUST import core error structures, default localization mappings, and shared foundational utilities exclusively from the centralized Zod core module rather than re-declaring error classes or formatting logic locally.
