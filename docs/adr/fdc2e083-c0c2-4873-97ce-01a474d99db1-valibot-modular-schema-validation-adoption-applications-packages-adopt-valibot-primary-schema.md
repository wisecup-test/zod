...
1. MUST: Applications and packages MUST adopt Valibot as the primary schema definition and runtime validation library for modular payload validation.

## Policy Block

- MUST Applications and packages MUST adopt Valibot as the primary schema definition and runtime validation library for modular payload validation.
