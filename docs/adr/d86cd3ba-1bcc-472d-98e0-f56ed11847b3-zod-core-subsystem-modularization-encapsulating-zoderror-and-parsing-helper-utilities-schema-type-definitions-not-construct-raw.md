...
1. MUST: Schema type definitions MUST NOT construct raw validation errors directly and MUST route all validation issue construction through dedicated error utility helpers and localized message formatting modules.

## Policy Block

- MUST Schema type definitions MUST NOT construct raw validation errors directly and MUST route all validation issue construction through dedicated error utility helpers and localized message formatting modules.
