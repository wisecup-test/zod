...
1. MUST: All service API boundaries MUST define explicit schemas using a declarative schema validation library (e.g., Zod, JSON Schema)

## Policy Block

- MUST All service API boundaries MUST define explicit schemas using a declarative schema validation library (e.g., Zod, JSON Schema)
