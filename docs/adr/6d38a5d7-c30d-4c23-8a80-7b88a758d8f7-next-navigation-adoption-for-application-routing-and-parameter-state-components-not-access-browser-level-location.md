# next/navigation Adoption for Application Routing and Parameter State: Components Not Access Browser Level Location
...
1. MUST_NOT: Components MUST_NOT access browser-level location, history, or URL parsing objects directly when equivalent primitives are provided by the adopted routing module.

## Policy Block

- MUST_NOT Components MUST_NOT access browser-level location, history, or URL parsing objects directly when equivalent primitives are provided by the adopted routing module.
