...
1. MAY: Downstream consumers and specialized processing modules MAY interact with standard schema interfaces through dedicated bridge modules to support cross-ecosystem protocols.

## Policy Block

- MAY Downstream consumers and specialized processing modules MAY interact with standard schema interfaces through dedicated bridge modules to support cross-ecosystem protocols.
