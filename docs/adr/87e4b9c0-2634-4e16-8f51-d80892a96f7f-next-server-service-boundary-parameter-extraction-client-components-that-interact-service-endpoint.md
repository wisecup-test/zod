...
1. SHOULD: Client components that interact with service endpoint query parameters SHOULD align parameter key naming conventions with corresponding server boundary definitions.

## Policy Block

- SHOULD Client components that interact with service endpoint query parameters SHOULD align parameter key naming conventions with corresponding server boundary definitions.
