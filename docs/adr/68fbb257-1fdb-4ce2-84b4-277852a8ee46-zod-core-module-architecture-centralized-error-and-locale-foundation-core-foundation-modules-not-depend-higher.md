...
1. MUST_NOT: Core foundation modules MUST NOT depend on higher-level schema combinators, external facades, or downstream helper modules, preserving strict unidirectional dependency flow.

## Policy Block

- MUST_NOT Core foundation modules MUST NOT depend on higher-level schema combinators, external facades, or downstream helper modules, preserving strict unidirectional dependency flow.
