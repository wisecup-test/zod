...
1. MUST: All validation failures emitted during parse operations MUST conform to the structured issue schema established by the central error class hierarchy.

## Policy Block

- MUST All validation failures emitted during parse operations MUST conform to the structured issue schema established by the central error class hierarchy.
