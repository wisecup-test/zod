...
1. MUST_NOT: Content endpoints and transformation utilities MUST NOT bypass the fumadocs-core/source abstraction to read raw content files directly, except when loading companion metadata artifacts defined outside the page tree schema.

## Policy Block

- MUST_NOT Content endpoints and transformation utilities MUST NOT bypass the fumadocs-core/source abstraction to read raw content files directly, except when loading companion metadata artifacts defined outside the page tree schema.
