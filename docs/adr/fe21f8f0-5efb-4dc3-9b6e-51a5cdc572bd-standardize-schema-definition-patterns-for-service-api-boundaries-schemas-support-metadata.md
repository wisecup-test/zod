...
1. SHOULD: Schemas SHOULD support metadata annotations (descriptions, examples, defaults) to enable automatic documentation generation

## Policy Block

- SHOULD Schemas SHOULD support metadata annotations (descriptions, examples, defaults) to enable automatic documentation generation
