...
1. MUST: All components importing @inkeep/cxkit-react MUST declare the use client directive at the top of the module boundary.

## Policy Block

- MUST All components importing @inkeep/cxkit-react MUST declare the use client directive at the top of the module boundary.
