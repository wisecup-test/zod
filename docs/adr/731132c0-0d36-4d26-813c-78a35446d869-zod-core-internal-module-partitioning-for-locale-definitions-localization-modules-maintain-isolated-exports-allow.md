...
1. SHOULD: Localization modules SHOULD maintain isolated exports to allow consumers to include individual locale dictionaries without bundling unreferenced languages or runtime parsers.

## Policy Block

- SHOULD Localization modules SHOULD maintain isolated exports to allow consumers to include individual locale dictionaries without bundling unreferenced languages or runtime parsers.
