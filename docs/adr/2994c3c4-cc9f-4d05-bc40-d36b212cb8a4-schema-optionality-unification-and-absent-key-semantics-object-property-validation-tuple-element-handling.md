...
1. SHOULD: Object property validation and tuple element handling SHOULD adhere to the unified opt-in and opt-out propagation rules specified in wiki/optionality.md.

## Policy Block

- SHOULD Object property validation and tuple element handling SHOULD adhere to the unified opt-in and opt-out propagation rules specified in wiki/optionality.md.
