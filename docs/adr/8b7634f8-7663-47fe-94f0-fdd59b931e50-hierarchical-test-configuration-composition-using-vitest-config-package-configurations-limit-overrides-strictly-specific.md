...
1. SHOULD: Package configurations SHOULD limit overrides strictly to package-specific scope, such as package root directories, mock setups, or test include filters.

## Policy Block

- SHOULD Package configurations SHOULD limit overrides strictly to package-specific scope, such as package root directories, mock setups, or test include filters.
