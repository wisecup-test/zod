...
1. SHOULD: Variant entry points SHOULD re-export core definitions directly from the external module interface while applying only variant-specific configuration or subset filtering.

## Policy Block

- SHOULD Variant entry points SHOULD re-export core definitions directly from the external module interface while applying only variant-specific configuration or subset filtering.
