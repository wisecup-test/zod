...
1. MUST: All external data inputs (API requests, user submissions, configuration files, third-party integrations) MUST be validated using Zod schemas before processing

## Policy Block

- MUST All external data inputs (API requests, user submissions, configuration files, third-party integrations) MUST be validated using Zod schemas before processing
