# next/navigation Adoption for Application Routing and Parameter State: Client Components That Observe Search Parameters
...
1. MUST: Client components that observe search parameters or navigation events MUST isolate interactive side effects within lifecycle hooks and declare explicit client boundary directives.

## Policy Block

- MUST Client components that observe search parameters or navigation events MUST isolate interactive side effects within lifecycle hooks and declare explicit client boundary directives.
