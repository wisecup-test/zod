...
1. MAY: Schemas MAY include transformation logic (e.g., .transform(), .preprocess()) for data normalization before storage

## Policy Block

- MAY Schemas MAY include transformation logic (e.g., .transform(), .preprocess()) for data normalization before storage
