...
1. MUST: Content transformation pipelines MUST process document nodes through ordered remark middleware chains compatible with the configured MDX source pipeline.

## Policy Block

- MUST Content transformation pipelines MUST process document nodes through ordered remark middleware chains compatible with the configured MDX source pipeline.
