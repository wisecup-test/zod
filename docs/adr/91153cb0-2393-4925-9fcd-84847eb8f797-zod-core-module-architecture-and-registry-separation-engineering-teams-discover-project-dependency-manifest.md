...
1. MUST: Engineering teams MUST discover the project dependency manifest and resolve the exact locked version from the repository resolution artifact prior to implementing or consuming library primitives.

## Policy Block

- MUST Engineering teams MUST discover the project dependency manifest and resolve the exact locked version from the repository resolution artifact prior to implementing or consuming library primitives.
