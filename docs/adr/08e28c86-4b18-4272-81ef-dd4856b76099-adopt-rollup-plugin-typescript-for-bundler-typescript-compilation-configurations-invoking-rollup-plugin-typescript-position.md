...
1. MUST: Configurations invoking @rollup/plugin-typescript MUST position the plugin appropriately relative to module resolution plugins to ensure TypeScript source files are resolved before transpilation.

## Policy Block

- MUST Configurations invoking @rollup/plugin-typescript MUST position the plugin appropriately relative to module resolution plugins to ensure TypeScript source files are resolved before transpilation.
