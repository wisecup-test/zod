...
1. SHOULD: Complex nested data structures SHOULD use composed schemas rather than inline validation logic

## Policy Block

- SHOULD Complex nested data structures SHOULD use composed schemas rather than inline validation logic
