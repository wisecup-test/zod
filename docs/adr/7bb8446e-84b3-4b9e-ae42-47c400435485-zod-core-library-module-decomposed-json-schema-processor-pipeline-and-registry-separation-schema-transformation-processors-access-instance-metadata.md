...
1. MUST: Schema transformation processors MUST access instance metadata through the centralized registry lookup abstractions rather than attaching mutable serialization state directly to schema definition instances.

## Policy Block

- MUST Schema transformation processors MUST access instance metadata through the centralized registry lookup abstractions rather than attaching mutable serialization state directly to schema definition instances.
