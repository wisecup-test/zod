...
1. SHOULD: Global registries and metadata cache structures SHOULD be accessed through designated registry boundaries rather than direct global state mutation.

## Policy Block

- SHOULD Global registries and metadata cache structures SHOULD be accessed through designated registry boundaries rather than direct global state mutation.
