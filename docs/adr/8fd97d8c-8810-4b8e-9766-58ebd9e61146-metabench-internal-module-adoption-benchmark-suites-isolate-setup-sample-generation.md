...
1. SHOULD: Benchmark suites SHOULD isolate benchmark setup and sample generation from timed evaluation routines orchestrated by the harness.

## Policy Block

- SHOULD Benchmark suites SHOULD isolate benchmark setup and sample generation from timed evaluation routines orchestrated by the harness.
