...
1. SHOULD_NOT: Schema transformation logic SHOULD NOT mutate incoming schema definitions or global registry tables during context traversal.

## Policy Block

- SHOULD_NOT Schema transformation logic SHOULD NOT mutate incoming schema definitions or global registry tables during context traversal.
