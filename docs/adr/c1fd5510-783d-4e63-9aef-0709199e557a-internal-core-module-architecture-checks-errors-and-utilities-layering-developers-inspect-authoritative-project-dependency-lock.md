...
1. MUST: Developers MUST inspect the authoritative project dependency lock artifact to determine the exact resolved versions of all internal and external dependencies before modifying or adding consumer modules.

## Policy Block

- MUST Developers MUST inspect the authoritative project dependency lock artifact to determine the exact resolved versions of all internal and external dependencies before modifying or adding consumer modules.
