...
1. MUST: Consumers and contributors MUST discover the repository dependency lock artifact and verify the exact resolved version before integrating or modifying core library module dependencies.

## Policy Block

- MUST Consumers and contributors MUST discover the repository dependency lock artifact and verify the exact resolved version before integrating or modifying core library module dependencies.
