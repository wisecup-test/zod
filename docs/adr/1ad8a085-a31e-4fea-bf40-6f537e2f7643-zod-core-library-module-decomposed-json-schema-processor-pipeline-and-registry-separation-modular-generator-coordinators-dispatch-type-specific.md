...
1. SHOULD: Modular generator coordinators SHOULD dispatch type-specific serialization tasks to dedicated processor handlers matching each schema definition category.

## Policy Block

- SHOULD Modular generator coordinators SHOULD dispatch type-specific serialization tasks to dedicated processor handlers matching each schema definition category.
