...
1. MUST_NOT: Internal core submodules MUST_NOT establish circular import paths or execute cross-submodule side effects during module initialization.

## Policy Block

- MUST_NOT Internal core submodules MUST_NOT establish circular import paths or execute cross-submodule side effects during module initialization.
