...
1. MUST: Workspace packages that configure unit testing suites MUST define their configuration by importing defineConfig and mergeConfig from vitest/config and merging package-level options with the shared root test configuration module.

## Policy Block

- MUST Workspace packages that configure unit testing suites MUST define their configuration by importing defineConfig and mergeConfig from vitest/config and merging package-level options with the shared root test configuration module.
