...
1. MUST: Before implementing schema definitions with drizzle-orm/pg-core, the consumer MUST inspect the repository lock artifact to determine the exact resolved dependency version and consult matching reference documentation.

## Policy Block

- MUST Before implementing schema definitions with drizzle-orm/pg-core, the consumer MUST inspect the repository lock artifact to determine the exact resolved dependency version and consult matching reference documentation.
