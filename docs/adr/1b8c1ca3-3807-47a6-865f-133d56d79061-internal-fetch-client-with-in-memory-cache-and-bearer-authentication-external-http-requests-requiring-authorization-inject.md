...
1. MUST: External HTTP requests requiring authorization MUST inject credentials from environment configuration via standard bearer authentication headers.

## Policy Block

- MUST External HTTP requests requiring authorization MUST inject credentials from environment configuration via standard bearer authentication headers.
