...
1. MUST: Tooling scripts and workspace generators MUST import file system capabilities exclusively via the protocol-prefixed node:fs module specifier.

## Policy Block

- MUST Tooling scripts and workspace generators MUST import file system capabilities exclusively via the protocol-prefixed node:fs module specifier.
