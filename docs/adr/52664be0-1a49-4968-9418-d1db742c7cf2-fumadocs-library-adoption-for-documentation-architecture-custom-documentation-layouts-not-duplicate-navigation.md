...
1. MUST_NOT: Custom documentation layouts MUST NOT duplicate navigation drawer, table-of-contents, or sidebar state logic already provided by Fumadocs layout primitives.

## Policy Block

- MUST_NOT Custom documentation layouts MUST NOT duplicate navigation drawer, table-of-contents, or sidebar state logic already provided by Fumadocs layout primitives.
