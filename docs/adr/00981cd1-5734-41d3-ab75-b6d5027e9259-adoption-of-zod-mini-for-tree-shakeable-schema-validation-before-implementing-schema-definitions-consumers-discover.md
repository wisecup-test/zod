...
1. MUST: Before implementing schema definitions, consumers MUST discover the project package manifest and lock artifact to inspect and bind to the exact resolved library version.

## Policy Block

- MUST Before implementing schema definitions, consumers MUST discover the project package manifest and lock artifact to inspect and bind to the exact resolved library version.
