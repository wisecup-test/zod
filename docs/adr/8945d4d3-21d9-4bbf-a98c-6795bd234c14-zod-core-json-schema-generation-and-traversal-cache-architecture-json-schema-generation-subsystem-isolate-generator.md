...
1. MUST: The JSON Schema generation subsystem MUST isolate generator orchestration, processor dispatch, and registry lookups into distinct cohesive modules coordinated through a shared traversal context.

## Policy Block

- MUST The JSON Schema generation subsystem MUST isolate generator orchestration, processor dispatch, and registry lookups into distinct cohesive modules coordinated through a shared traversal context.
