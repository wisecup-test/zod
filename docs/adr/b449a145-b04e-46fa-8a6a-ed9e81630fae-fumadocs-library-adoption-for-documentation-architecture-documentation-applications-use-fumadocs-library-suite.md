...
1. MUST: Documentation applications MUST use the Fumadocs library suite (`fumadocs-ui` and `fumadocs-core`) as the foundational framework for documentation layouts, content source loading, and search component dialogs.

## Policy Block

- MUST Documentation applications MUST use the Fumadocs library suite (`fumadocs-ui` and `fumadocs-core`) as the foundational framework for documentation layouts, content source loading, and search component dialogs.
