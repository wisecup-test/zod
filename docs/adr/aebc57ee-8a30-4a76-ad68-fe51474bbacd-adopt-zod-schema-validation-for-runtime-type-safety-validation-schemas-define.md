...
1. MUST: Validation schemas MUST define explicit types and constraints for all expected fields, rejecting unknown properties by default

## Policy Block

- MUST Validation schemas MUST define explicit types and constraints for all expected fields, rejecting unknown properties by default
