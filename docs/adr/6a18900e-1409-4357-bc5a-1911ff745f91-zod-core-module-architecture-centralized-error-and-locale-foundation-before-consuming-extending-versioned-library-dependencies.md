...
1. MUST: Before consuming or extending versioned library dependencies, the engineering team MUST discover the repository dependency manifest and resolution artifact to verify the exact locked version and validate that core module exports conform to that recorded resolution.

## Policy Block

- MUST Before consuming or extending versioned library dependencies, the engineering team MUST discover the repository dependency manifest and resolution artifact to verify the exact locked version and validate that core module exports conform to that recorded resolution.
