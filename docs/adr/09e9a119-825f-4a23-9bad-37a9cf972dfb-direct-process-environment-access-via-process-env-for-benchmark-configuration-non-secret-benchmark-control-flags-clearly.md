...
1. SHOULD: Non-secret benchmark control flags SHOULD be clearly separated from sensitive credentials and system secret stores through dedicated configuration namespaces.

## Policy Block

- SHOULD Non-secret benchmark control flags SHOULD be clearly separated from sensitive credentials and system secret stores through dedicated configuration namespaces.
