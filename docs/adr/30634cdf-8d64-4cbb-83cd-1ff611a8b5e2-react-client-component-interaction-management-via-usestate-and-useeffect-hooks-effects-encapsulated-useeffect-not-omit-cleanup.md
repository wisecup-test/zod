...
1. MUST_NOT: Effects encapsulated in useEffect MUST_NOT omit cleanup handlers when subscribing to external events, intervals, or asynchronous subscriptions.

## Policy Block

- MUST_NOT Effects encapsulated in useEffect MUST_NOT omit cleanup handlers when subscribing to external events, intervals, or asynchronous subscriptions.
