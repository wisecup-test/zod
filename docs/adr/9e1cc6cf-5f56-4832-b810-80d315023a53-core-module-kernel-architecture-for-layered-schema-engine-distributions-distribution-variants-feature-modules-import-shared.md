...
1. MUST: All distribution variants and feature modules MUST import shared schema validation primitives, execution utilities, and registry instances exclusively from the centralized core module.

## Policy Block

- MUST All distribution variants and feature modules MUST import shared schema validation primitives, execution utilities, and registry instances exclusively from the centralized core module.
