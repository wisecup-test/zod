...
1. MUST: Schema metadata associations, schema identifier lookups, and serialization mappings MUST be managed through dedicated bidirectional registries rather than attaching arbitrary mutable properties directly to schema instances.

## Policy Block

- MUST Schema metadata associations, schema identifier lookups, and serialization mappings MUST be managed through dedicated bidirectional registries rather than attaching arbitrary mutable properties directly to schema instances.
