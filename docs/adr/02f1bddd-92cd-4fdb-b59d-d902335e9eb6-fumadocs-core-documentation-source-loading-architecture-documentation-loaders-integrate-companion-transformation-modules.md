...
1. MAY: Documentation loaders MAY integrate companion transformation modules to process MDX syntax trees when preparing content for specialized downstream extraction.

## Policy Block

- MAY Documentation loaders MAY integrate companion transformation modules to process MDX syntax trees when preparing content for specialized downstream extraction.
