...
1. MUST_NOT: Entry facade modules MUST NOT introduce custom reimplementations of core functions that bypass or diverge from the shared external module contract.

## Policy Block

- MUST_NOT Entry facade modules MUST NOT introduce custom reimplementations of core functions that bypass or diverge from the shared external module contract.
