...
1. MUST: The consumer MUST inspect the repository lock or resolution artifact to determine the exact resolved dependency versions before implementing or modifying module integrations.

## Policy Block

- MUST The consumer MUST inspect the repository lock or resolution artifact to determine the exact resolved dependency versions before implementing or modifying module integrations.
