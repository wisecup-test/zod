...
1. SHOULD: Schema definitions SHOULD be tested independently with dedicated test suites covering edge cases and validation rules

## Policy Block

- SHOULD Schema definitions SHOULD be tested independently with dedicated test suites covering edge cases and validation rules
