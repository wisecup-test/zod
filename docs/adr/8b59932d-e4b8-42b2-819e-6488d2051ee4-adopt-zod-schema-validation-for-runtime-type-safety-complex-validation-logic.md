...
1. SHOULD: Complex validation logic SHOULD use Zod refinements and transformations to encode business rules within schemas

## Policy Block

- SHOULD Complex validation logic SHOULD use Zod refinements and transformations to encode business rules within schemas
