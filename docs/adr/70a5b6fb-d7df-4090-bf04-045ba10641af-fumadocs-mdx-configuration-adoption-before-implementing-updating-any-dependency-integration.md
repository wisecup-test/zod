...
1. MUST: Before implementing or updating any dependency integration, the consumer MUST inspect the repository lock or resolution artifact to determine and adhere to the exact resolved dependency version.

## Policy Block

- MUST Before implementing or updating any dependency integration, the consumer MUST inspect the repository lock or resolution artifact to determine and adhere to the exact resolved dependency version.
