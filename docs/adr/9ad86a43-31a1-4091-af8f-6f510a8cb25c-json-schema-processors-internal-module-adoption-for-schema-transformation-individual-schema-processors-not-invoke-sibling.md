...
1. MUST_NOT: Individual schema processors MUST NOT invoke sibling processors directly; nested and referenced schema conversions MUST be delegated through the central schema transformation dispatcher.

## Policy Block

- MUST_NOT Individual schema processors MUST NOT invoke sibling processors directly; nested and referenced schema conversions MUST be delegated through the central schema transformation dispatcher.
