...
1. MUST_NOT: Service handlers MUST_NOT directly mutate incoming searchParams instances or rely on implicit parameter presence without defensive boundary assertions.

## Policy Block

- MUST_NOT Service handlers MUST_NOT directly mutate incoming searchParams instances or rely on implicit parameter presence without defensive boundary assertions.
