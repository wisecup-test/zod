...
1. SHOULD_NOT: Schema generation orchestration modules SHOULD NOT contain inline type-specific transformation branches and MUST rely on registered processors.

## Policy Block

- SHOULD_NOT Schema generation orchestration modules SHOULD NOT contain inline type-specific transformation branches and MUST rely on registered processors.
