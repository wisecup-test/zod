...
1. MUST: All test files MUST use the .test.ts extension for TypeScript test files

## Policy Block

- MUST All test files MUST use the .test.ts extension for TypeScript test files
