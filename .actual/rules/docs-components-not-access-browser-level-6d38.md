...
- **R-NAV-001** MUST_NOT: Components MUST_NOT access browser-level location, history, or URL parsing objects directly when equivalent primitives are provided by the adopted routing module.
