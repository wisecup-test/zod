...
These rules are ALWAYS ACTIVE for core library modules responsible for schema definition, parsing, validation checks, error dispatch, and schema registries.

### Rules

- **R-ZOD-001** MUST: Cross-schema metadata lookups and global schema instances MUST coordinate through the global registry interface rather than maintaining ad-hoc module-local caches.
