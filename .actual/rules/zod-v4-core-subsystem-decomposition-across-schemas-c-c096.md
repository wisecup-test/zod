...
- **R-ZOD-001** MUST: Validation issue creation and error formatting MUST reside within the dedicated error module and interface with check and schema execution via structured error callbacks.
