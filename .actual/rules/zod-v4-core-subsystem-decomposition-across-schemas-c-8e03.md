...
- **R-ZOD-001** MUST_NOT: Internal utility modules MUST NOT introduce circular runtime dependencies between schema compilation primitives and downstream parsing routines.
