...
- **R-NAV-001** MUST: Client components that observe search parameters or navigation events MUST isolate interactive side effects within lifecycle hooks and declare explicit client boundary directives.
