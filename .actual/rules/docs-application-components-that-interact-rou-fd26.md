# next/navigation Adoption for Application Routing and Parameter State: Application Components That Interact Route State
...
- **R-NAV-001** MUST: Application components that interact with route state, navigate programmatically, or access search parameters MUST import navigation primitives exclusively from next/navigation.
...
# Run repository linting and static analysis scripts to confirm no forbidden window location or history references exist in UI modules.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. Automated continuous integration checks, static analysis lint rules, and pull request architectural peer reviews verify module import compliance.
</enforcement>