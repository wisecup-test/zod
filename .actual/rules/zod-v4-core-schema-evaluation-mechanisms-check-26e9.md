...
- **R-ZOD-001** MUST: All core schema evaluation mechanisms, check processors, and error collection utilities MUST reside within the decoupled core engine module, isolating foundational schema mechanics from compatibility interfaces and external serializers.
