...
- **R-ZOD-001** MAY: Processors MAY deep-copy default values and serialize intermediate property representations using isolated transformation passes to ensure immutability of original definitions.
