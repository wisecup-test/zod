...
- **R-NAV-001** SHOULD: Documentation pages and components SHOULD prefer declarative navigation links over imperative navigation calls unless programmatic state transitions are required.
